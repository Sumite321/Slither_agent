...
public abstract class Snake<GME extends Game<?, ?>> extends Entity<GME> implements Comparable<Snake>,Serializable {
    public String name;
    public int id;
